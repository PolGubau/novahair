/** biome-ignore-all lint/correctness/useExhaustiveDependencies: No cal */
"use client";
...
function SidebarProvider({
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: No cal
		...
		>
			...
			>
				<div
					...
					className="bg-background group-data-[variant=floating]:border-foreground/20 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
				>
					{children}
				</div>
			</div>
...
function SidebarTrigger({
	...
	return ( <IconButton
		...
		icon={
				<>
				<ChevronLeft className={cn("max-md:hidden",{"rotate-180": !open})} />
...
function SidebarGroupAction({
	...
	return (
		<Comp
			...
			className={cn(
				"text-foreground ring-sidebar-ring hover:bg-foreground/10 hover:text-foreground/10 absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
	...
	return (
		<Comp
			...
			className={cn(
				"text-foreground ring-sidebar-ring hover:bg-foreground/10 hover:text-foreground/10 peer-hover/menu-button:text-foreground/10 absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
				// Increases the hit area of the button on mobile.
				"after:absolute after:-inset-2 md:after:hidden",
				...
				"group-data-[collapsible=icon]:hidden",
				showOnHover &&
					"peer-data-[active=true]/menu-button:text-foreground/10 group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 md:opacity-0",
				className,
			)}
			{...props}
		/>
	...
	return (
		<div
			...
			className={cn(
				...
				"peer-hover/menu-button:text-foreground/10 peer-data-[active=true]/menu-button:text-foreground/10",
				"peer-data-[size=sm]/menu-button:top-1",
				"peer-data-[size=default]/menu-button:top-1.5",
				"peer-data-[size=lg]/menu-button:top-2.5",
				"group-data-[collapsible=icon]:hidden",
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn(
				"border-foreground/20 mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5",
				"group-data-[collapsible=icon]:hidden",
				className,
			)}
			{...props}
