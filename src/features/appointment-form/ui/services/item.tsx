...
export const ServiceItem = ({ service }: Props) => {
	return (
		<li className="rounded-2xl overflow-hidden shadow bg-foreground/3 gap-5 grid grid-cols-[1fr_2fr] items-center">
			<div className="h-full bg-foreground/10 w-full grid place-items-center">
				{service.imageUrl && (
					<img
