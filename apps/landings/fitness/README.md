# FITZONE - Landing para Gimnasios y Centros Fitness

Landing page moderna para gimnasios y centros deportivos, construida con TanStack Router, React Query y Tailwind CSS.

## 🚀 Características

- ✅ **Sistema de reservas online** - Los miembros pueden reservar clases fácilmente
- ✅ **Multi-tenant** - Soporta múltiples gimnasios con tenant ID
...
│   └── services/      # Listado de clases y servicios
