	...
	return (
		...
		>
			<div
				...
				className="group/field flex w-full data-[invalid=true]:text-destructive flex-row items-center gap-1.5 overflow-hidden px-3 py-1.5 transition-all duration-300 ease-linear relative has-data-[state=checked]:pl-10"
			>
