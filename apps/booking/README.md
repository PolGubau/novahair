# NOVAHAIR Booking - Sistema de Reservas

Sistema de reservas independiente para peluquerías y salones de belleza, construido con TanStack Router, React Query y Tailwind CSS.

## 🚀 Características

- ✅ **Sistema de reservas online** - Los clientes pueden agendar citas fácilmente
- ✅ **Multi-tenant** - Soporta múltiples salones con tenant ID
...
- ✅ **Embebible** - Puede integrarse vía iframe o como componente React
...
Esta aplicación requiere un Tenant ID para funcionar. Hay dos formas de proporcionarlo:

### 1. Parámetro de URL (Recomendado para producción)
```
https://booking.domain.com?tenant=YOUR_TENANT_ID


<!-- Example -->
<!-- https://booking.domain.com?tenant=69740a1c-2996-4bc0-b7a6-d5236d68ce25 -->
```
 

### 2. localStorage (Se guarda automáticamente)
El tenant ID se guarda automáticamente en localStorage cuando se proporciona via URL.

## 🌐 Integración

### Como sitio web independiente
Despliega en tu dominio/subdominio:
```
https://booking.tudominio.com?tenant=SALON_ID
```

### Como iframe
```html
<iframe 
  src="https://booking.tudominio.com?tenant=SALON_ID" 
  width="100%" 
  height="800px"
  frameborder="0"
></iframe>
...
### Como componente React (futuro)
```jsx
import { BookingWidget } from '@novahair/booking';

<BookingWidget tenantId="SALON_ID" />
```
